...
const BentoHome = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div className="bento-container bento-grid-home pt-8 md:pt-12 lg:pt-20 relative z-10">
        ...
        <div className="bento-box bento-hero bento-gradient-1 flex flex-col justify-center">
          <div className="w-full max-w-3xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent"
                style={{ backgroundImage: 'var(--gradient-accent)', wordBreak: 'break-word' }}>
              Hi, I'm Austn
            </h1>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-4 sm:mb-6" style={{ color: 'var(--text-secondary)', wordBreak: 'break-word' }}>
        ...
        <div className="bento-box bento-medium bento-gradient-2 flex flex-col h-full">
          <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold mb-2 sm:mb-3 md:mb-4" style={{ color: 'var(--text-primary)' }}>
            Core Skills
          </h3>
          <div className="space-y-2 md:space-y-3 flex-1">
            <div className="glass-thick rounded-lg p-3 md:p-4 transition-transform hover:scale-105">
              <h4 className="font-medium flex items-center gap-2 text-sm md:text-base" style={{ color: 'var(--text-primary)' }}>
                <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: 'var(--accent-color)' }}></span>
                Frontend
              </h4>
              <p className="text-xs md:text-sm pl-4 mt-1" style={{ color: 'var(--text-muted)' }}>
                React, Vue, TypeScript, Tailwind
              </p>
            </div>
            <div className="glass-thick rounded-lg p-3 md:p-4 transition-transform hover:scale-105">
              <h4 className="font-medium flex items-center gap-2 text-sm md:text-base" style={{ color: 'var(--text-primary)' }}>
                <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: 'var(--purple-accent)' }}></span>
                Backend
              </h4>
              <p className="text-xs md:text-sm pl-4 mt-1" style={{ color: 'var(--text-muted)' }}>
            ...
            <div className="glass-thick rounded-lg p-3 md:p-4 transition-transform hover:scale-105">
              <h4 className="font-medium flex items-center gap-2 text-sm md:text-base" style={{ color: 'var(--text-primary)' }}>
                <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ backgroundColor: 'var(--teal-accent)' }}></span>
                Cloud & DevOps
              </h4>
              <p className="text-xs md:text-sm pl-4 mt-1" style={{ color: 'var(--text-muted)' }}>
        ...
        <div className="bento-box bento-large">
          <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4" style={{ color: 'var(--text-primary)' }}>
            Recent Work
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            <div className="apple-card group p-4 sm:p-6">
              <div className="hidden sm:block absolute top-0 right-0 w-20 h-20 opacity-10"
                   style={{ background: 'var(--gradient-accent)', filter: 'blur(20px)' }}></div>
              <h4 className="text-base sm:text-lg font-semibold mb-2">Enterprise SaaS Platform</h4>
              <p className="text-xs sm:text-sm mb-2 sm:mb-3 break-words" style={{ color: 'var(--text-muted)' }}>
            ...
            <div className="apple-card group p-4 sm:p-6">
              ...
              <h4 className="text-base sm:text-lg font-semibold mb-2">Real-time Analytics Dashboard</h4>
              <p className="text-xs sm:text-sm mb-2 sm:mb-3 break-words" style={{ color: 'var(--text-muted)' }}>
        ...
        <div className="bento-box bento-medium flex flex-col h-full">
          ...
          <article className="space-y-3 md:space-y-4 flex-1 flex flex-col">
            <h4 className="text-base md:text-lg font-semibold line-clamp-2" style={{ color: 'var(--text-primary)' }}>
              Building Scalable React Applications
            </h4>
            <p className="text-sm md:text-base line-clamp-3 flex-1" style={{ color: 'var(--text-muted)' }}>
            ...
            <a href="/blog" className="apple-link text-sm md:text-base inline-flex items-center group mt-auto">
              Read more 
        ...
        <div className="bento-box bento-small bento-gradient-3 flex flex-col justify-center items-center text-center group hover:scale-105 p-3 sm:p-6">
          <div className="text-2xl sm:text-3xl font-bold mb-1" 
               style={{ background: 'var(--gradient-vibrant)', 
                       WebkitBackgroundClip: 'text',
                       WebkitTextFillColor: 'transparent' }}>5+</div>
          <div className="text-xs sm:text-sm" style={{ color: 'var(--text-muted)' }}>Years Experience</div>
        </div>

        <div className="bento-box bento-small bento-gradient-1 flex flex-col justify-center items-center text-center group hover:scale-105 p-3 sm:p-6">
          <div className="text-2xl sm:text-3xl font-bold mb-1" 
               style={{ background: 'var(--gradient-accent)', 
                       WebkitBackgroundClip: 'text',
                       WebkitTextFillColor: 'transparent' }}>50+</div>
          <div className="text-xs sm:text-sm" style={{ color: 'var(--text-muted)' }}>Projects Delivered</div>
        </div>

        <div className="bento-box bento-small bento-gradient-2 flex flex-col justify-center items-center text-center group hover:scale-105 p-3 sm:p-6">
          <div className="text-2xl sm:text-3xl font-bold mb-1" 
               style={{ background: 'var(--gradient-cool)', 
                       WebkitBackgroundClip: 'text',
                       WebkitTextFillColor: 'transparent' }}>100%</div>
          <div className="text-xs sm:text-sm" style={{ color: 'var(--text-muted)' }}>Client Satisfaction</div>
        </div>
        ...
        <div className="bento-box bento-wide relative overflow-visible flex items-center">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 w-full">
            <div className="flex-1">
              <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>
                Arena Shooter
              </h3>
              <p className="text-sm md:text-base mb-3 md:mb-4" style={{ color: 'var(--text-muted)' }}>
                A fast-paced 3D browser game built with Three.js
              </p>
              <a href="/games/arena-shooter" className="btn btn-gradient-vibrant text-sm md:text-base">
