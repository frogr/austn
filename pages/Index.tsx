...
const Index = () => {
  ...
  return (
    <div className={`min-h-screen px-2 py-6 md:px-4 lg:px-6 transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      <MatrixRain intensity="light" color="rgba(57, 255, 20, 0.8)" />
      
      {/* Header */}
      <header className="mb-6 text-center pt-4">
        <div className="inline-block mb-3 px-3 py-1 bg-terminal-dark text-neon-green border border-neon-green/30 text-xs font-mono">
          <span className="animate-blink">▋</span> Backend Developer / System Architect
        </div>
        <h1 className="font-mono text-4xl md:text-5xl mb-3 text-white text-glitch">
      ...
      {/* Bento Layout */}
      <main className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-1 max-w-6xl mx-auto">
        {/* About Me */}
        ...
        <div className="grid grid-cols-3 gap-1 md:col-span-3 lg:col-span-4">
      ...
      {/* Footer */}
      <footer className="mt-6 text-center text-gray-500 text-xs font-mono">
        <div className="waveform-divider w-32 mx-auto mb-3"></div>
